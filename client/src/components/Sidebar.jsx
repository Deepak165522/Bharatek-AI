...
<div className='flex items-center gap-2 p-3 mt-4 border border-gray-400 dark:border-white/20 rounded-md'>
  <FiSearch className='text-lg text-gray-600 dark:text-white' />
  <input
      ...
      .map((chat) => (
        ...
        >
          <div>
            ...
            <p className='text-xs text-gray-500 dark:text-[#B1A6C4]'>
              {moment(chat.updatedAt).fromNow()}
            </p>
          </div>
         <FiTrash2
  className='hidden group-hover:block w-4 h-4 cursor-pointer text-gray-500 dark:text-[#B1A6C4] hover:text-red-500'
  title="Delete Chat"
/>
...
>
  <FiImage className='w-4.5 h-4.5 text-gray-700 dark:text-white' />
...
<div
  ...
  className='flex items-center gap-2 p-3 mt-4 border border-gray-300 dark:border-white/15 rounded-md cursor-pointer hover:scale-103 transition-all'
>
  <RiVipDiamondLine className='w-4.5 h-4.5 text-gray-700 dark:text-white' />
  <div className='flex flex-col text-sm'>
...
<div className='flex items-center justify-between gap-2 p-3 mt-4 border border-gray-300 dark:border-white/15 rounded-md'>
  ...
  <div className='flex items-center gap-2 text-sm'>
    <FiMoon className='w-4 h-4 text-gray-700 dark:text-white' />
    <p>Dark Mode</p>
  </div>
...
<div className='flex items-center gap-3 p-3 mt-4 border border-gray-300 dark:border-white/15 rounded-md cursor-pointer group'>
  ...
  <FiUser className='w-7 h-7 text-gray-700 dark:text-primary rounded-full' />
  ...
  {user && (
    <FiLogOut className='h-5 w-5 cursor-pointer hidden group-hover:block text-gray-600 dark:text-primary' />
  )}
</div>

<FiX
onClick={()=> setIsMenuOpen(false)}
className='absolute top-3 right-3 w-5 h-5 cursor-pointer md:hidden text-black dark:text-white' />
